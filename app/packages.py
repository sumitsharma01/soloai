...
PACKAGES = {
 ...
 'email-support': {'name': 'Email Support', 'trigger': 'email.received', 'description': 'Thoughtful email drafts, ready for your review.', 'permissions': ['read_email', 'draft_email', 'get_booking', 'search_policy'], 'instructions': 'Draft a helpful support email using only the supplied business guidance. Do not send mail or claim actions were completed. Return only the draft.'}
}
