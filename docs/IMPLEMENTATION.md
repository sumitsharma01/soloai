...
For people running or developing SoloAI. Start with the [customer guide](GETTING-STARTED.md) if you just want to try the product. Commands below run from the repository root.
